...
defineProps({ olts: Array, ponPorts: Array });
const form = useForm({ name: '', olt_id: '', pon_port_id: '', lat: '', lng: '', address: '', capacity: 96, used_ports: 0, splitter_ratio: '1:8', is_active: true, notes: '' });
