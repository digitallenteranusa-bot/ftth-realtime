...
const props = defineProps({ odc: Object, olts: Array, ponPorts: Array });
const form = useForm({ name: props.odc.name, olt_id: props.odc.olt_id || '', pon_port_id: props.odc.pon_port_id || '', lat: props.odc.lat, lng: props.odc.lng, address: props.odc.address || '', capacity: props.odc.capacity, used_ports: props.odc.used_ports, splitter_ratio: props.odc.splitter_ratio, is_active: props.odc.is_active, notes: props.odc.notes || '' });
